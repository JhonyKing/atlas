...
| 002 | Comparador tecnológico | Implementación local completa; evidencia live de precios y cierre documental pendientes | 2: T047-T048 | `specs/002-technology-comparator/tasks.md` |
...
| 018 | Production deployment | Fundación local implementada: Vercel, API/Cron bounded por colección, worker portable, readiness, CI, migración y evidencia redacted; activación externa aún pendiente | 7: T031-T036,T052 | `specs/018-production-deployment/tasks.md` |
...
1. Activar el API/Cron programado, sus secretos y la evidencia operativa para cerrar T031–T036 y T052 de Feature
...
`foreign_key_indexes` y `comparison_pricing_contract` en el proyecto Supabase de producción. El remoto está en 33 migraciones con
`comparison_pricing_contract` como head; las siete
