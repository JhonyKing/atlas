...
- [X] CMP-008 Add deterministic dataset cases for two-, three-, and four-technology comparisons. (20 requests and four-row Anthropic case are verified against the promoted snapshot.)
