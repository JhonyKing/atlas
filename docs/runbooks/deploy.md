...
For Vercel, set the project **Root Directory** to `apps/web`. The GitHub environment must provide `VERCEL_TOKEN`, `VERCEL_ORG_ID`, and the
environment-specific project ID (`VERCEL_PREVIEW_PROJECT_ID` or
