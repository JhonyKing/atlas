-- Reserve one anonymous cited-answer question under a transaction-level visitor lock.
-- The caller supplies p_now so deterministic tests can use a frozen clock.
