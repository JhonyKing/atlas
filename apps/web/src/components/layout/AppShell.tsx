...
const localeTargetCopy = {
  "en-US": { flag: "🇲🇽", label: "Español", ariaLabel: "Switch to Spanish" },
  "es-MX": { flag: "🇺🇸", label: "English", ariaLabel: "Cambiar a inglés" },
} as const;
    ...
    <div className="atlas-shell">
      ...
      <header className="atlas-header">
        ...
        <button className="atlas-locale-switch" type="button" onClick={switchLocale} aria-label={targetCopy.ariaLabel}>
          <span className="atlas-locale-flag" aria-hidden="true">{targetCopy.flag}</span>
