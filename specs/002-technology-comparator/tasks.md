...
- [ ] T040 [US1] Expand `evals/datasets/comparison-v1.jsonl` to at least 20 representative comparison requests and record matrix citation precision, useful-progress latency and terminal latency for SC-CMP-001, SC-CMP-002 and SC-CMP-004. (Progress: dataset has 20 requests and 17 deterministic matrix cases with structure/state/evidence parity 1.0; live run recorded 12 cells in `evals/results/live-comparator-t040-20260807.json` at 68,751 ms; review worksheet with source URLs/excerpts is in `evals/results/live-comparator-t040-20260807-review.md`; manual ground-truth decision remains.)
