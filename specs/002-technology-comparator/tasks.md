...
- [ ] T032 [P] [US3] Add deterministic two-, three- and four-technology comparison cases with expected cell states and evidence IDs in `evals/datasets/comparison-v1.jsonl`. (Progress: 20 requests, 17 matrix cases and a four-row Anthropic fixture are present and tested; verified fourth corpus evidence remains pending T039.)
