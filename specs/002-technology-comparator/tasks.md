...
- [X] T036 Run the feature quickstart and all backend/frontend quality gates, recording results in `evals/results/002-technology-comparator-baseline.md`. (Evidence: 174 backend tests passed, migrations upgraded, comparison evaluator 2/2, frontend lint/typecheck passed and 11 Playwright tests passed.)
